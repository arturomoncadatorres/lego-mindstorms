...
#
# # Source code
# You can find the code in the accompanying [`.py` file](https://github.com/arturomoncadatorres/lego-mindstorms/blob/main/base/charlie/programs/here_i_go.py). To get it running, simply copy and paste it in a new Mindstorms project.
#
# # Imports
