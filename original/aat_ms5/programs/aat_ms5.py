...
#
# # Source code
# You can find the code in the accompanying [`.py` file](https://github.com/arturomoncadatorres/lego-mindstorms/blob/main/original/aat_ms5/programs/aat_ms5.py). To get it running, simply copy and paste it in a new Mindstorms project.
#
# # Imports
